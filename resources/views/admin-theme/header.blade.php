        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
                    ...
                    <li class="scrollable-container media-list">
                        <div class="list-item align-items-center">
                            ...
                            <div class="list-item-body flex-grow-1">
                                ...
                                <div class="cart-item-qty">
                                    <div class="input-group"><input class="touchspin-cart" type="number" value="1"></div>
                                </div>
                        ...
                        <div class="list-item align-items-center">
                            ...
                            <div class="list-item-body flex-grow-1">
                                ...
                                <div class="cart-item-qty">
                                    <div class="input-group"><input class="touchspin-cart" type="number" value="3"></div>
                                </div>
                        ...
                        <div class="list-item align-items-center">
                            ...
                            <div class="list-item-body flex-grow-1">
                                ...
                                <div class="cart-item-qty">
                                    <div class="input-group"><input class="touchspin-cart" type="number" value="2"></div>
                                </div>
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    <li class="scrollable-container media-list">
                        ...
                        <div class="list-item d-flex align-items-center">
                            ...
                            <div class="form-check form-check-primary form-switch"><input class="form-check-input" id="systemNotification" type="checkbox" checked=""><label class="form-check-label" for="systemNotification"></label></div>
                        </div>
                        <a class="d-flex" href="#">
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{ authed()->name }}</span><span class="user-status">{{ \App\Enums\AdminRole::getDescription(authed()->role) }}</span></div>
                    <span class="avatar"><img class="round" src="{{ authed()->avatar }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                </a>
