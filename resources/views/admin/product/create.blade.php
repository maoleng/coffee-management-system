                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-2">
                                    ...
                                    <input name="price" type="text" class="form-control numeral-mask" placeholder="10,000" id="numeral-formatting">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-2">
                                    <label class="form-label" for="blog-edit-slug">Expired In (months)</label>
                                    <input name="expire_month" type="text" class="form-control numeral-mask" placeholder="12">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-2">
