                        ...
                        <div class="row">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="category_id" id="blog-edit-category" class="select2 form-select">
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if ($product->category_id === $category->id) checked @endif>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-2">
                                    ...
                                    <input name="price" value="{{ $product->prettyPrice }}" type="text" class="form-control numeral-mask" placeholder="10,000" id="numeral-formatting">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-2">
                                    <label class="form-label" for="blog-edit-slug">Expired In (months)</label>
                                    <input name="expire_month" value="{{ $product->expire_month }}" type="text" class="form-control numeral-mask" placeholder="12">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-2">
                            ...
                            <div class="col-12 mb-2">
                                <div class="border rounded p-2">
                                    ...
                                    <div class="d-flex flex-column flex-md-row">
                                        <img src="{{ asset($product->images[0]->path ?? null) }}" id="blog-feature-image" class="rounded me-2 mb-1 mb-md-0" width="170" height="110" alt="Put images here" />
