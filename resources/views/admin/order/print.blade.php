            ...
            <div class="invoice-print p-3">
                <div class="invoice-header d-flex justify-content-between flex-md-row flex-column pb-2">
                    ...
                    <div class="mt-md-0 mt-2">
                        <h4 class="invoice-title">
                            Ordered At:
                            <span class="invoice-number">{{ $ordered_at }}</span>
                        </h4>
                    </div>
                </div>
                ...
                <div class="row invoice-sales-total-wrapper mt-3">
                    <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                        <p class="card-text mb-0"><span class="fw-bold">Salesperson:</span> <span class="ms-75">{{ $sales }}</span></p>
                    </div>
                    <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                        <div class="invoice-total-wrapper">
                            <div class="invoice-total-item">
                                <p class="invoice-total-title">Subtotal:</p>
                                <p class="invoice-total-amount">{{ $fee['sub_total'] }}</p>
                            </div>
                            <div class="invoice-total-item">
